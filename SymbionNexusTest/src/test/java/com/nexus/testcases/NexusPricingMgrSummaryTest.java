...
import com.nexus.pages.NexusPricingMgrSummaryPage;
...
public class NexusPricingMgrSummaryTest extends NexusTestBase{
	...
	NexusPricingMgrSummaryPage pricingMgrSummary;
	
	public NexusPricingMgrSummaryTest() {
		super();
	}
	...
	@Test
	public void pricingMgrSummary() throws InterruptedException {
		...
		homePage = loginPage.loginSupplier(prop.getProperty("usernamepricingmgr"), prop.getProperty("password"));
		Thread.sleep(2000);
		pricingMgrSummary = new NexusPricingMgrSummaryPage();
		pricingMgrSummary.pricingMgrSummaryDetails();
	}
